...
class AirCargoProblem(Problem):
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        # if problem is passed we can trim off all preconditions and thereby make all 
        # actions eligible before starting the search however here the node (state)
        # is passed so find how many fluents away from reaching goal.
...
def air_cargo_p2() -> AirCargoProblem:
    ...
    #instead of asserting Cargo(C1) / Plane(P1) / Airport(SFO), keep them in list
    cargos = ['C1', 'C2', 'C3']     
    planes = ['P1', 'P2', 'P3']
...
if __name__ == '__main__':
    ...
    # rs(p, "A-star_search - ignore preconditions heuristic", astar_search, p.h_ignore_preconditions)
    # print("A-star levelsum heuristic")
    # rs(p, "A-star_search - levelsum heuristic", astar_search, p.h_pg_levelsum)